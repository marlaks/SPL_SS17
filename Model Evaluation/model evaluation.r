...
for (i in 1:10) {
    ...
    svm.results.precision = append(svm.results.precision, Precision(scaledTest$y, svm.results, 
        positive = "2.83281884796041"))
...
for (i in 1:10) {
    ...
    nnt.results.precision = append(nnt.results.precision, Precision(MinMaxTest$y, nnt.results, 
        positive = "1"))
